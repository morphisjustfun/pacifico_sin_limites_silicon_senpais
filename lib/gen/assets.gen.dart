...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [closeIcon, errorIcon];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/pacifico_logo.png
  AssetGenImage get pacificoLogo =>
      const AssetGenImage('assets/images/pacifico_logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [pacificoLogo];
}
